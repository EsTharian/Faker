...
> ONLY IMAGE FAKER CHANGED FOR https://picsum.photos/ 
...
### `Faker\Provider\Image`
    ...
    // Image generation provided by https://picsum.photos/
    imageUrl($width = 640, $height = 480) // 'https://picsum.photos/640/480/'
